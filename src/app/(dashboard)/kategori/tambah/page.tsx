...
import { createKategori } from "@/lib/actions/kategori"
...
export default function TambahKategoriPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await createKategori({ nama: form.get("nama") as string })
    ...
    <div className="mx-auto max-w-lg space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Buat kategori barang baru</p>
        </div>
      </div>
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="nama" name="nama" placeholder="Masukkan nama kategori" required />
